...
namespace app\domains\article\ar;
...
abstract class ArticleTag extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \app\domains\article\query\ArticleTagQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\domains\article\query\ArticleTagQuery(get_called_class());
    }
}
