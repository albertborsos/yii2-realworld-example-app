...
abstract class Article extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \app\domains\article\query\ArticleQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\domains\article\query\ArticleQuery(get_called_class());
    }
}
