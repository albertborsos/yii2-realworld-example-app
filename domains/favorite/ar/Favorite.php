...
namespace app\domains\favorite\ar;
...
abstract class Favorite extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \app\domains\favorite\query\FavoriteQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\domains\favorite\query\FavoriteQuery(get_called_class());
    }
}
