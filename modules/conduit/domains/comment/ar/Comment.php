...
namespace app\modules\conduit\domains\comment\ar;
...
abstract class Comment extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \app\modules\conduit\domains\comment\query\CommentQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\conduit\domains\comment\query\CommentQuery(get_called_class());
    }
}
